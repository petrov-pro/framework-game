...
abstract public class BaseGraphic {
    ...
    protected ActionInterface.Type action;
    protected WorldInterface.Vector vector;

    public BaseGraphic(ActionInterface.Type action, WorldInterface.Vector vector, boolean isLoop) {
        this.stateTime = 0f;
        this.isLoop = isLoop;
        this.action = action;
        this.vector = vector;
    ...
    public BaseGraphic(ActionInterface.Type action, boolean isLoop) {
        this.stateTime = 0f;
        this.isLoop = isLoop;
        this.action = action;
    }
