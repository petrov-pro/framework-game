...
public class LoadingScreen extends ScreenAdapter {
    ...
    private HandlerInterface returnScene;
    ...
    public LoadingScreen(ManagerScenes managerScenes) {
        ...
        assets.loadTexture("backGroundLoading", "backgroud-loading.jpg");
        assets.getManager().finishLoading();
        backGround = assets.get("backGroundLoading");
    }

    public void setReturnScene(HandlerInterface returnScene) {
    ...
    public void render(float delta) {
        if (returnScene.getAssets().isUploaded()) {
            managerScenes.setScreen(returnScene.getScreen());
        } else {
