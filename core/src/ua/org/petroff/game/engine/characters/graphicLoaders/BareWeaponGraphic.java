...
public class BareWeaponGraphic implements GraphicLoaderInterface {
    ...
    public HashMap<String, GraphicElement> loadAnimation(Sprite sprite, Assets asset, String regionName, float velocityFireAnimation) {
        ...
        TextureRegion[] creatureRegionsFireRight = new TextureRegion[6];
        TextureRegion[] creatureRegionsFireLeft = new TextureRegion[6];
        ...
        for (int i = 0; i < creatureRegionsFireRight.length; i++) {
            creatureRegionsFireRight[i] = new TextureRegion(creatureTexture2, 64 * i, 66, 64, 64);
        }
        ...
        for (int i = 0; i < creatureRegionsFireLeft.length; i++) {
            creatureRegionsFireLeft[i] = new TextureRegion(creatureTexture1, 64 * i, 838, 64, 64);
        }
